...
string input_folder = "C:\\006-MyWork-2021\\Terramera\\MyTasks\\Task-01\\data\\Test\\";


// the input image file name
// string input_image_fname = input_folder + "building.jpg";
string fname = "DAI 1-I3.jpg";
string input_image_fname = input_folder + fname;
...
// string output_folder = "C:\\Users\\mghaz\\Documents\\MyProfDev\\MyPD-2021\\Udemy\\Courses\\Completed\\OpenCV\\Course-001\\Exercises\\OpenCV-Installation\\results\\";
string output_folder = "C:\\006-MyWork-2021\\Terramera\\MyTasks\\Task-01\\results\\";
...
int main(int argc, char** argv)
{
    ...
    for (size_t i = 0; i < lines.size(); i++)
    {
        ...
        double angle = abs(atan2(lines[i][3] - lines[i][1], lines[i][2] - lines[i][0]) * 180.0 / CV_PI);
        if ( angle < 5 || angle > 80 )
    ...
    imshow("Source", src);
    imwrite(output_folder + fname, src);

    //namedWindow("Detected Lines", 1);
    //imshow("Detected Lines", color_dst);
    //imwrite(output_folder + "color_dst.jpg", color_dst);
